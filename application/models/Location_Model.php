...
class Location_Model extends CI_Model {
	...
	public function Allcountry($tab,$condi,$or)
	{
		$this->db->select("*");
		$this->db->where($condi);
		$this->db->or_where($or);
	...
	{
		$this->db->select("contry");
		$this->db->where($id);
		$qry=$this->db->get($tab);
		return $qry->row_array();

	}
	public function getstatename($tab,$id)
	{
	...
	public function getstate($tab,$where)
	{
		$this->db->select("*");
		$this->db->where($where);
		$qry=$this->db->get($tab);
	...
	public function delcity($tab,$condi)
	{
		$this -> db -> where($condi);
    	$this -> db -> delete($tab);
    	return true;
