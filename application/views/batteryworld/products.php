						...
						<div class="product-filter filters-panel">
							...
							<div class="row">
	                        	...
	                        	<div class="col-md-5 visible-lg module" style="margin:0; width: 70%;">
	                                ...
	                                <ul class="breadcrumb" style="margin:0;background-color:#fdd600;padding-bottom:#000;">
...
<div class="products-list row grid " id="ItemData"> 
	<?php  
  foreach($itemdetails as $itemm){  $pic=explode(",",$itemm['item_pic']);?>
			<form method="post">
 ...
 <div class="left-block redirect showLoading" redirecturl="<?php echo site_url('detailspage')?>">
     <div class="product-image-container second_img ">
       ...
       <img alt="Mixed Dried Berries" class="img-responsive lazy" src="<?php echo base_url()?>item/<?php echo $pic[0]?>" style="display: block;">
                    ...
                    <div class="caption">
                        ...
                        <p class="block-ellipsis"><?php echo $itemm['description'];?></p>
                        <div class="price">
                            <span class="price-new"><?php echo '₹'.$itemm['price'];?></span> 
                                                    </div>
   ...
   {?>
   <a href="javascript:void(0);" data-toggle="modal" data-original-title="Add to Cart" id="AddtoCartt" class="btn btn-mega btn-lg" data-target="#loginModel" style="color: #fff; font-weight:400 !important">Add to Cartf</a> 
<?php } ?>
   <?php if(isset($user['username']))
   {?>
