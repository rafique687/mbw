						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>/section/insetbanner" method="post" enctype="multipart/form-data"> 
								<div class="form-group"> 
									...
									<input type="text" class="form-control" id="" name="title" placeholder="Banner Title" required="" value="<?php echo set_value('title'); ?>" > 
								...
								<div class="form-group"> 
									...
									<input type="text" class="form-control" id="" name="textt" placeholder="Banner Title" required="" value="<?php echo set_value('textt'); ?>" > 
									<?php if(form_error('textt'))
										{?>
										<div class="custom"> <?php echo strip_tags(form_error('title'));?></div>
								...
								<div class="form-group"> 
		                        	...
		                        	<select class="form-control" name="banner_section" required="" id="pcate">
		                        		...
		                        		<option <?php if(set_value('banner_section')=='privacy'){ echo 'selected';}?> value="privacy">Privacy Policy</option>  
		                        		<option <?php if(set_value('banner_section')=='faq'){ echo 'selected';}?> value="faq">FAQ</option>
		                        		<option <?php if(set_value('banner_section')=='vegetable'){ echo 'selected';}?> value="vegetable">vegetable</option>
		                        		<option <?php if(set_value('banner_section')=='fruits'){ echo 'selected';}?> value="vegetable">truits</option>   	
                         			</select>
								</div>
							    <div class="form-group">
