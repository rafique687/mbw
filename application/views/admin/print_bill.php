...
<!-- main content start-->
    <div id="page-wrapper">
      <div class="main-page">
        ...
        <h2 class="title1">Mobile Battery World</h2>
       
        <div class="table-responsive bs-example widget-shadow" id="bill">
          <h3 style="text-align:center">Mobile Battery World</h3>
          <div class="row">
            <div class="col-md-6">
             <h5>
             
               <!-- <div class="col-sm-4"><img class='pull-right' src="<?php echo $src ;?>"></div> -->
             ...
             <div class="col-md-6 text-right"><img class='pull-right' src="<?php echo $src ;?>"></div>
            </div>
            <!--  <div class="col-md-6"><img class='pull-right' src="<?php echo $src ;?>"></div> -->
