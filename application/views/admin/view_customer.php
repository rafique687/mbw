...
<!-- main content start-->
 ...
 <input type="checkbox"  value="<?php echo $cust['email'];?>" name="rowSelectCheckBox[]">
 	<?php echo $i ?>
				                   ...
				                   <td>
				                    	<a href="<?php echo site_url()?>/customer/editcutomer/?id=<?php echo $cust['reg_id']?>" class="btn btn-info">
				                    		<i class="fa fa-edit"></i>
										</a>
										
                        				<a href="<?php echo site_url()?>/customer/deletecustomer/?id=<?php echo $cust['reg_id']?>" class="btn btn-danger">
