							...
							<!-- <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> -->
								...
								<div class="profile_img">	
									<span class="prfil-img">
										<img src="<?php echo base_url()?>/dp/<?php echo $sessiontrue=$this->session->userdata('dp');?>" onerror="this.onerror=null; this.src='<?php echo base_url()?>/dp/userpic.jpg'" alt="" style="width:50px !important; height: 50px !important;"> </span> 
