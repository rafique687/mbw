      ...
      <nav class="navbar navbar-inverse">
          ...
          <h1>
            <a class="navbar-brand" href="<?php echo base_url()?>dashboard/mydashboar">
             ...
             <!--  <?php echo $sessiontrue=$this->session->userdata('Site_name');?> -->
              <img src="<?php echo base_url().'settingpic/'.$sessiontrue=$this->session->userdata('logo');?>" style="width: 100%; height: 80%;"/></span>
         ...
         <li class="treeview">
          ...
          <li>
                  ...
                  <li>
                    <a href="<?php echo site_url()?>/dashboard/setting?sectionid=8">
              ...
              <li class="treeview">
                <a href="<?php echo site_url()?>/Manage_order/view_order">
