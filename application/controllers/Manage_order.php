...
class Manage_order extends CI_Controller {
	...
	public function generatebill()
	{
		...
		$data['src']=base_url()."barcode.php?code=".$_GET['orderid'];
	...
	{  //echo "string";exit();
		$condi = array('orderid' =>$_GET['id']);
		$fire=$this->Order_Model->deleteorder("order_table",$condi);
		if($fire)
		{
			//echo "string";exit();
			redirect("Manage_order/view_order?success=Order delete Successfull");
		}
