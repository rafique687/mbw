            ...
            <div class="col-md-12">
              <div class="about-text">
                <div class="about-heading-wrap">
                  <h2 class="about-heading mb-20 mt-20 py-2">Return and Refund policy<span> </span></h2>
                </div>
                <p><?php //echo $about['about'][3]['field_value']?>
                Return and Refund policy

The Period of raise a request for Return/Replacement is 24 hours after received the order. 
If You received a defective product, not fresh and not as a described. then you can raise a request for Return /Replacement.
If you are not satisfied with quality of products. Please Let us know. After getting the order back, money will be refund to you by credit to your bank account.
You can raise a request for replacement on the website/mail with in applicable return policy.
                </p>
              </div>
            </div>
          </div>
