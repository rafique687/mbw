<div class="header section pt-15 pb-15">
        <div class="container">
          <div class="row">
            <div class="navbar-header col-2 header-bottom-left"> <a class="navbar-brand" href="index.php"> <img alt="Bigmarket" src="<?php echo $mydata['baseurl'];?>settingpic/<?php echo $mydata['basic'][3]['field_value'];?>"> </a> </div>
              ...
              <?php
                 ...
                 //echo $api_prod;
                  ...
                  foreach($Rootcate as  $rootcate) {?>
                      ...
                      <li <?php if($rootcate['product_name']=="Grocery & Staples"){?>class="main_cat dropdown active"<?php } else {?> class="main_cat dropdown" <?php  }?> > <a href="subcategory.php?id=<?php echo $rootcate['prod_id'];?>&folder=products">
            ...
            //echo "<pre>"; print_r($vegetable);
              ...
              <div class="shopcart">
                <div id="cart" class="btn-block mt-40 mb-30 ">
                  <button type="button" class="btn" data-target="#cart-dropdown" data-toggle="collapsee" aria-expanded="true"><span id="shippingcart">My basket</span><span id="cart-total">Item 0</span></button>
                  <a href="cart_page.php" class="cart_responsive btn"><span id="cart-text">My basket</span><span id="cart-total-res">0</span> </a>
                </div>
