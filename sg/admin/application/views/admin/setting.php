...
<?php }
 ...
 <?php  } 
	...
	<?php }
						...
						<div class="form-group">
							<img src="<?php echo base_url()?>settingpic/<?php echo $setting['field_value']?>" onerror="this.onerror=null; this.src='<?php echo base_url()?>/dp/userpic.jpg'" width="10%" height="10%"> </div>
