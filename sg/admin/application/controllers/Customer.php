...
public function deletecustomer()
{
	...
	$condi=array("reg_"=>$_GET['id']);
	$fire=$this->customer_modal->delcustomer("registeration",$condi);
	if($fire)
	{
		redirect("customer");
	}
...
public function editcutomer()
{
	...
	$data['editid']=$_GET['id'];
	$data['customer'] = $this->customer_modal->customerdetails("registeration",$condi);
				...
				if ($this->form_validation->run() == FALSE)
					{
						...
						$data['containt'] = "admin/editcustomer.php";
						$condi=array("reg_id"=>$_POST['regi_id']);
						$data['customer'] = $this->customer_modal->customerdetails("registeration",$condi);
					$this->load->view('admin.php',$data);
					}
				else
					{
						...
						$fire= $this->customer_modal->updatecustomer("registeration",$feeddata,$condi);
						if($fire)
						{
							redirect("Customer");
						}	
