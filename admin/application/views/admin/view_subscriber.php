...
<!-- main content start-->
				...
				<div class="tables">
				  ...
				  <?php } ?>
					...
					<div class="table-responsive bs-example widget-shadow">
						<form action="<?php echo site_url()?>/Subscriber/composemail" method="post">
 ...
 <input type="checkbox"  value="<?php echo $cust['mail'];?>" name="rowSelectCheckBox[]">
 	<?php echo $i ?>
									</td>
								    <td><?php echo $cust['mail'];?></td>
								  
								    <td><?php echo $cust['sucrib_date'];?></td> 
								  
				                   
				                   <td>
				                    	<a href="<?php echo site_url()?>/Subscriber/editcutomer/?id=<?php echo $cust['sucribid']?>" class="btn btn-info">
				                    		<i class="fa fa-edit"></i>
										</a>
										
                        				<a href="<?php echo site_url()?>/Subscriber/deletecustomer/?id=<?php echo $cust['sucribid']?>" class="btn btn-danger">
